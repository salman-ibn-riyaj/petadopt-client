  ...
  const reasons = [
    {
      ...
      title: "Save a Life",
      description:
        "Each year, millions of pets enter shelters. Adoption gives these lovable animals a second chance at a happy life.",
    },
    {
      icon: <ShieldCheck className="w-8 h-8" />,
      title: "Fully Vetted",
      description:
        "Most shelter pets are already vaccinated, microchipped, and spayed/neutered, making the transition easier for you.",
    },
    {
      icon: <Home className="w-8 h-8" />,
      title: "Lifelong Bond",
      description:
        "Adopted pets often show incredible gratitude. You're not just getting a pet; you're gaining a loyal family member.",
    },
  ];
      ...
      >
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="text-center mb-12 md:mb-20">
            <h2
              className="text-3xl md:text-5xl font-bold mb-4 transition-colors
          ...
          <div className="mt-16 text-center">
            <p
              className="italic text-sm md:text-base transition-colors
